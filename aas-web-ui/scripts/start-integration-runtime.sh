...
if [ "$TARGET" = "preview" ]; then
  ...
  export VITE_COPYRIGHT_NAME="${VITE_COPYRIGHT_NAME:-}"
  export VITE_LEGAL_NOTICE_URL="${VITE_LEGAL_NOTICE_URL:-}"
  export VITE_PRIVACY_POLICY_URL="${VITE_PRIVACY_POLICY_URL:-}"
