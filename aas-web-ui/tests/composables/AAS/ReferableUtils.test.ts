...
describe('ReferableUtils.ts; Tests for \'nameToDisplay()\'', () => {
  ...
  for (const nameToDisplayTestDataset of nameToDisplayTestData) {
    // Define test data
...
describe('ReferableUtils.ts; Tests for \'descriptionToDisplay()\'', () => {
  ...
  for (const descriptionToDisplayTestDataset of descriptionToDisplayTestData) {
    // Define test data
...
describe('ReferableUtils.ts; Tests for \'checkIdShort()\'', () => {
  ...
  for (const checkIdShortTestDataset of checkIdShortTestData) {
    // Define test data
