...
describe('SemanticIdUtils.ts; Tests for checkSemanticId()', () => {
  ...
  for (const semanticIdTestCombination of semanticIdTestCombinations) {
    // Define test data
...
describe('SemanticIdUtils.ts; Tests for getEquivalentEclassSemanticIds()', () => {
  ...
  for (const equivalentElcassSemanticId of equivalentElcassSemanticIds) {
    // Define test data
...
describe('SemanticIdUtils.ts; Tests for getEquivalentIriSemanticIds()', () => {
  ...
  // Tests for getEquivalentEclassSemanticId()
  for (const equivalentIriSemanticId of equivalentIriSemanticIds) {
    // Define test data
