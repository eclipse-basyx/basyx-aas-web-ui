...
import { ABAC_ENDPOINT_PATHS, ABAC_ROUTE_PATHS, CONTEXT, RULE_SUB_PATHS, VERSION_SUB_PATHS } from './constants/api'
...
export function useAbacClient (disableMessage = false) {
  ...
  const apiUrl = computed(() => {
    // Todo: is there a way to get the origin directly form the store?
    const urlObj = new URL(aasRegistryUrl.value)
