    ...
    function highlightXml(): void {
        ...
        try {
            ...
            if (Prism && Prism.highlight) {
                formattedXml.value = Prism.highlight(formatted, Prism.languages.markup || {}, 'markup');
            } else {
...
<style scoped>
    .xml-container {
        ...
        display: flex;
        position: relative;
        /* Container shouldn't have overflow */
        overflow: hidden;
    }
    ...
    .xml-content {
        ...
        line-height: 1.5;
        flex-grow: 1;
        /* Content should have scrollbars */
        overflow: auto;
    ...
    /* Add external styling for Prism */
    :deep(.token.tag) {
        color: #905;
    }
