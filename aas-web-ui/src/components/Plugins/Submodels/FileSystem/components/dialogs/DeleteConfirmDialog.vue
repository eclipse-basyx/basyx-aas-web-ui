...
<script setup lang="ts">
  ...
  function getContentType (item: FileSystemElement): string {
  ...
  function getItemDisplayName (item: FileSystemElement): string {
  ...
  function handleDelete (isActive: { value: boolean }): void {
    emit('confirm-delete')
