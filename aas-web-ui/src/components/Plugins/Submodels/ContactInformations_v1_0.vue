<template>
  <v-container class="pa-0" fluid>
    <VisualizationHeader
      default-title="Contact Information"
...
<script lang="ts" setup>
  ...
  async function initializeVisualization (): Promise<void> {
    ...
    const submodelElementData = await setData(
      { ...props.submodelElementData },
    ...
    for (const contactInformationSMC of contactInformationSMCs) {
      ...
      // Contact name
      const contactName = determineContactName(contactInformationSMC)
      if (contactName.trim() !== '') {
      ...
      const roleOfContactPersonMlp = getSubmodelElementByIdShort('RoleOfContactPerson', contactInformationSMC)
      ...
      // Telephone number
      const phoneSMC = getSubmodelElementByIdShort('Phone', contactInformationSMC)
      ...
      // Fax number
      const faxSMC = getSubmodelElementByIdShort('Fax', contactInformationSMC)
      ...
      // Email
      const emailSMC = getSubmodelElementByIdShort('Email', contactInformationSMC)
      if (
        emailSMC
