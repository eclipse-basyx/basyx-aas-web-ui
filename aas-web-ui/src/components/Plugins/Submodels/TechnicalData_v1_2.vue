...
<script lang="ts" setup>
  ...
  function extractProductClassifications (technicalData: any): void {
    const productClassificationsSMC_local = getSubmodelElementBySemanticId(
  ...
  function extractTechnicalProperties (technicalData: any): void {
    const technicalPropertiesSMC_local = getSubmodelElementBySemanticId(
  ...
  function extractFurtherInformation (technicalData: any): void {
    const furtherInformationSMC_local = getSubmodelElementBySemanticId(
