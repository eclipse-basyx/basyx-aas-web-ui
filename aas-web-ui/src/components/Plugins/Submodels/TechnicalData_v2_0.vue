<template>
  <v-container class="pa-0" fluid>
    <VisualizationHeader
      default-title="Technical Data for Industrial Equipment in Manufacturing"
                  ...
                  >
                    ...
                    <td>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <!-- Image note -->
                            <div v-if="getImageNote(imgEntry)" class="text-body-small">
                      ...
                      <template v-else-if="generalProperty.modelType == 'MultiLanguageProperty'">
                        ...
                        <div v-if="valueToDisplay(generalProperty)" class="text-body-small">
                    ...
                    >
                      ...
                      <td>
                        ...
                        <template v-if="furtherInfo.modelType == 'MultiLanguageProperty'">
                          <!-- Show english value, if available -->
                          <div v-if="valueToDisplay(furtherInfo)" class="text-body-small">
...
<script lang="ts" setup>
  ...
  function extractGeneralInformation (technicalData: any): void {
    const generalInformationSMC_local = getSubmodelElementBySemanticId(
  ...
  function extractFurtherInformation (technicalData: any): void {
    const furtherInformationSMC_local = getSubmodelElementBySemanticId('0173-1#02-ABK164#002', technicalData)
  ...
  function extractProductClassifications (technicalData: any): void {
    const productClassificationsSML_local = getSubmodelElementBySemanticId('0173-1#02-ABK162#002', technicalData)
  ...
  function extractTechnicalProperties (technicalData: any): void {
    const technicalPropertiesSML_local = getSubmodelElementBySemanticId('0173-1#02-ABK163#002', technicalData)
  ...
  function extractSpecificDescription (technicalData: any): void {
    const specificDescriptionSML_local = getSubmodelElementBySemanticId('0173-1#02-ABM221#001', technicalData)
