...
<script setup lang="ts">
  ...
  async function saveEntity (): Promise<void> {
    ...
    entityObject.value.globalAssetId = globalAssetId.value !== null && globalAssetId.value !== '' ? globalAssetId.value : null

    entityObject.value.specificAssetIds = specificAssetIds.value !== null && specificAssetIds.value.length > 0 ? specificAssetIds.value : null
