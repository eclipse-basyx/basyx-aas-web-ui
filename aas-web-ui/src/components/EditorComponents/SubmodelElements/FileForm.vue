                    ...
                    <v-expansion-panel class="border-s-thin border-e-thin" :class="bordersToShow(1)">
                        ...
                        <v-expansion-panel-text>
                            <FileInput
                                ...
                                v-model:content-type="contenType"
                                :new-file="newFile"
                                :sme-path="path"
...
*/
    ...
    const contenType = ref<string>('application/unknown');
    ...
    async function initializeInputs(): Promise<void> {
        if (!props.newFile && props.file) {
            ...
            if (fileObject.value.contentType) {
                contenType.value = fileObject.value.contentType;
            }
            ...
            filePath.value = null;
            contenType.value = 'application/unknown';
